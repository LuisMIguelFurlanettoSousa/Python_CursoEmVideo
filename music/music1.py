...
def main():
    ...
    # Carrega a música (substitua 'caminho_para_musica.mp3' pelo caminho correto)
    pygame.mixer.music.load('caminho_para_musica.mp3')

    # Inicia a reprodução da música
    pygame.mixer.music.play()

    # Exibe as letras enquanto a música toca
    print_lyrics()
